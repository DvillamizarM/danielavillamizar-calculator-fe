...
3. Pasted the full assignment spec and asked: *"this is are the impleemntation specs
...
4. *"do you think it might be necesarry to add a bff for the frontend?"*
   → Recommended against it (single backend, single client, no aggregation/auth need
   to justify the extra hop).

5. *"ok i am creating the repos give me a good brief description for the front"* and
   *"give me a description for the backend repo too"*
   → Short GitHub repo descriptions for both repos.

6. *"this is the location for both repos ... i will now read over the plan and give
   you the go ahead"*
   → No action; acknowledged and waited.

7. *"lets start with the backend"*
...
8. *"add the README and Dockerfile for the backend, make sure the readme meets the
   criteria"*
...
9. *"give me the commit it msg and i'll do it myself"* → *"do not do liine jumps"*
   → Provided a single-line Conventional Commits message; the user committed it
   themselves.

10. *"let's start the frontend"*
...
11. *"just checked it works perfectly! what else could we add that would have added
